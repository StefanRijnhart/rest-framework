...
class RestApiDispatcher(Dispatcher):
    ...
    def pre_dispatch(self, rule, args):
        ...
        if httprequest.mimetype == "application/json":
            ...
            try:
                ...
                _logger.info("%s: %s", self.request.path, msg)
            ...
            self.params = pyquerystring.parse(httprequest.query_string.decode("utf-8"))
        # TODO self._determine_context_lang()
        return res

    def dispatch(self, endpoint, args):
        """Same as odoo.http.HttpDispatcher. Inherit from that?"""
    ...
    def _determine_context_lang(self):
        ...
        available into Odoo.
        """
        accepted_langs = self.request.headers.get("Accept-language")
